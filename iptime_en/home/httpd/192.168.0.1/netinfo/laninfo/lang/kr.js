...
var S_lang = {
	"S_PAGE_TITLE" : "내부 네트워크 설정",
	"S_IP_TITLE" : "내부IP주소",
	"S_NETMASK_TITLE" : "서브넷마스크",
	//"S_GATEWAY_TITLE" : "내부게이트웨이",
	//"S_LANCONF_MANUALGATEWAY" : "다른게이트웨이",
	//"S_FDNS_TITLE" : "내부DNS서버",
	//"S_SDNS_TITLE" : "　",
	//"S_LANCONF_MANUALDNS" : "수동입력",
	"S_DHCPRUN_TITLE" : "DHCP서버동작",
	"S_SIP_TITLE" : "동작IP주소범위",
	"S_EIP_TITLE" : "　",
	"S_DHCPCONF_MIPRANGE" : "수동입력",
	...
	"S_SEARCHADDR_REG" : "검색된 주소 등록",
	"S_MANUALADDR_REG" : "수동 주소 등록",
	"S_REGADDR_MGR" : "등록된 주소 관리",

	"S_SEARCHADDR_REG" : "검색된 주소 등록",
	"S_MANUALADDR_REG" : "수동 주소 등록",
	"S_REGADDR_MGR" : "등록된 주소 관리",

	"S_ADDSEARCH_TITLE" : "검색된 주소 등록",
	...
	"S_INVALID_IPADDRESS_STRING" : "내부IP주소 값이 잘못 입력되었습니다.",
	"S_INVALID_NETMASKADDRESS_STRING" : "서브넷마스크 값이 잘못 입력되었습니다.",
	"S_INVALID_IPRANGEADDRESS_STRING" : "동작IP주소범위 값이 잘못 입력되었습니다.",
	"S_INVALID_DNSSUFFIX_STRING" : "DNS서픽스 값이 잘못 입력되었습니다.",
    "S_INVALID_SAME_EXT_INT_NETWORK" : "내부IP주소가 외부 네트워크와 같습니다.",
	"S_INVALID_NOT_SAME_NETWORK" : "내부IP주소와 동적IP주소범위는\n같은 네트워크로 설정해야합니다.",
