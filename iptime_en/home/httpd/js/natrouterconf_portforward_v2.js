...
function All_Enable_PFForm(doc)
{
	...
	/*EnableObj_For_PF(F.rule_name);*/		EnableObj_For_PF(F.re_ip);	EnableObj_For_PF(F.ext_sport);	EnableObj_For_PF(F.ext_eport);
	...
	/*EnableObj_For_PF(F.sel_server);*/		EnableObj_For_PF(F.wan_name);		EnableObj_For_PF(F.protocol);
...
function All_Disable_PFForm(doc)
{
	...
	/*DisableObj_For_PF(F.rule_name);*/		DisableObj_For_PF(F.re_ip);	DisableObj_For_PF(F.ext_sport);	DisableObj_For_PF(F.ext_eport);
	...
	/*DisableObj_For_PF(F.sel_server);*/	DisableObj_For_PF(F.wan_name);		DisableObj_For_PF(F.protocol);
