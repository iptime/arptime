...
var S_lang = {
	...
	"S_MAIN_PLEASE_INPUT_DESC" : "이름을 입력하세요.",

	"S_EMPTY_REMOTEPC_MAC" : "MAC주소를 입력하세요.",
	"S_ERROR_REMOTEPC_MAC" : "MAC주소가 잘못입력되었습니다.",

	"S_EMPTY_REMOTEPC_NAME" : "PC이름을 입력하세요.",
	"S_ERROR_REMOTEPC_NAME" : "PC이름이 잘못입력되었습니다.\n(32자 이내, 특수문자: @,#,(,),_,- 만 허용)",

	"S_MAIN_PCNAME" : "PC 이름",
	"S_MAIN_MACADDR" : "MAC 주소",
	"S_MAIN_CURRENTPC" : "현재 접속된 PC의 MAC주소로 설정",
	"S_MAIN_REMOTELIST_TITLEBAR" : "PC이름 / MAC주소",
	"S_MAIN_REMOTE_ON" : "PC켜기",
/*	
	...
	"S_EMPTY_C_HOSTSCAN_SPORT" : "시작포트를 능력하세요",
